...
path = os.path.join(os.path.expanduser('~'), 'python','reporting')
os.chdir(path)

connection = ea.DW_connect(linux=True)

print "Getting COMIT and HRC data"
inflow_file = os.path.join(os.path.expanduser('~'), 'walter_dw_home','comit','data','inflows.pickle')
storage_file =os.path.join(os.path.expanduser('~'), 'walter_dw_home','comit','data','storage.pickle')
ea_hrc = os.path.join(os.path.expanduser('~'), 'walter_dw_home','comit','data','hydroriskcurves','HRC_History_20130618.csv')   
